    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <form action="{{route('expenses.update', $edit->id)}}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group row">
                                <label for="exampleFormControlInput1" value={{$edit->tanggal}} class="col-sm-2">Tanggal</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="typecost" class="form-control typecost" required>
                                        <option value="{{$edit->id_cost}}">{{$edit->costto->type_of_cost}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="detail" value="{{$edit->costto->detail_of_cost}}" id="detailcost" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="cost" id="transaksi" value="{{number_format($edit->cost, 0, ',', '.')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="lokasi" class="form-control" id="" required>
                                        <option value={{$edit->id_lokasi}}>{{$edit->lokasito->lokasi}}</option>
