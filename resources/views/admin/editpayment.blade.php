    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <form action="{{route('payment.update', $py->id)}}" method="post">
                            @csrf
                            @method('put')
                            <div class="form-group row">
                                <label for="exampleFormControlInput1" class="col-sm-2">Nama Payment</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama_payment" value="{{$py->nama_payment}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="bank" value="{{$py->bank}}" name="bank" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="no-rekening" class="form-control" value="{{$py->no_rekening}}" name="no_rekening" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="bank" value="{{$py->nama}}" name="nama" required>
                                </div>
                            </div>
