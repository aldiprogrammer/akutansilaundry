    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <form action="{{route('deposit.update',$dp->id)}}" method="post">
                            @method('put')
                            @csrf
                            <div class="form-group row">
                                <label for="exampleFormControlInput1" class="col-sm-2">Tanggal</label>
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="tanggal" value="{{$dp->tanggal}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="wa" class="waupdate form-control">
                                        <option value="{{$dp->id_customer}}">{{$dp->wa}} | {{$dp->customer}}</option>
                                        @foreach ($cs as $item)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control customer" readonly name="customer" value="{{$dp->customer}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control saldo" readonly name="saldoawal" value="{{number_format($dp->saldo_awal, 0, ',', '.')}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control addsaldo rupiah" name="addsaldo" value="{{number_format($dp->tambah_saldo, 0, ',','.')}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control saldoakhir" readonly name="saldoakhir" value="{{number_format($dp->saldo_akhir, 0, ',', '.')}}" required>
